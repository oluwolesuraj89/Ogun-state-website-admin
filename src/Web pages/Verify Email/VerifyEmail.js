    ...
    return (
        <div className={classes.signin}>
            ...
            <div className={classes.signContainer}>
                <p className={classes.headerText}>Verify Email Address</p>
                <p className={classes.subText}>Enter the 4 digit code sent to your email address to continue your registration</p>
